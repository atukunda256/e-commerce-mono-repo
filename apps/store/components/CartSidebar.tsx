...
export default function CartSidebar() {
  ...
  const handleCreateOrder = async () => {
    ...
    try {
      ...
      // Handle error with inline error message instead of alert
      setOrderSuccess(false);
    ...
    return (
      <div className="h-full flex flex-col">
        ...
        <div className="text-center py-16 flex-grow flex flex-col items-center justify-center px-8">
          <div className="bg-green-50 rounded-lg p-8 w-full max-w-sm">
            <div className="rounded-full bg-green-100 p-4 mx-auto mb-6">
              <svg className="h-10 w-10 text-green-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              </svg>
            </div>
            <h3 className="text-2xl font-medium text-gray-900 mb-3">Order Successful!</h3>
    ...
    <div className="h-full flex flex-col">
      ...
      {items.length === 0 ? (
        <div className="flex-grow flex flex-col items-center justify-center text-gray-500 py-16 px-8">
          <div className="bg-gray-50 p-8 rounded-lg w-full max-w-sm">
            ...
            <p className="text-lg font-medium text-gray-800 mb-2 text-center">Your cart is empty</p>
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-end justify-between mt-2">
                            <div className="flex items-center border border-gray-300 rounded-md">
                              ...
                              <span className="px-2 py-1 text-xs w-7 text-center">
                                {item.quantity}
                              </span>
                              <button
                                onClick={() => updateQuantity(item.product.id, item.quantity + 1)}
